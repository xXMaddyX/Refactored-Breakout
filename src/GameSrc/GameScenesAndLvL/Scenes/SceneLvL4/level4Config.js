const stoneConfigLvL4 = {
    ...
    lila_stones: [
        ...
        {x: 100, y: 250, scale: 0.2, depth: 0},
        {x: 150, y: 300, scale: 0.2, depth: 0},
        {x: 200, y: 350, scale: 0.2, depth: 0},
        {x: 250, y: 400, scale: 0.2, depth: 0},
        {x: 300, y: 450, scale: 0.2, depth: 0},
        {x: 350, y: 500, scale: 0.2, depth: 0},
        {x: 400, y: 550, scale: 0.2, depth: 0},
        {x: 450, y: 600, scale: 0.2, depth: 0},
        {x: 500, y: 650, scale: 0.2, depth: 0},
        {x: 550, y: 700, scale: 0.2, depth: 0},
        {x: 600, y: 750, scale: 0.2, depth: 0},

        {x: 1800, y: 250, scale: 0.2, depth: 0},
        {x: 1750, y: 300, scale: 0.2, depth: 0},
        {x: 1700, y: 350, scale: 0.2, depth: 0},
        {x: 1650, y: 400, scale: 0.2, depth: 0},
        {x: 1600, y: 450, scale: 0.2, depth: 0},
        {x: 1550, y: 500, scale: 0.2, depth: 0},
        {x: 1500, y: 550, scale: 0.2, depth: 0},
        {x: 1450, y: 600, scale: 0.2, depth: 0},
        {x: 1400, y: 650, scale: 0.2, depth: 0},
        {x: 1350, y: 700, scale: 0.2, depth: 0},
        {x: 1300, y: 750, scale: 0.2, depth: 0},
